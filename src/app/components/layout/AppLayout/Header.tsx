...
export default function Header({ isShowSidebar, toggleSidebar, showNotifications }: HeaderProps) {
    ...
    return (
        <div className={`${isShowSidebar ? HEADER_PADDING_COLLAPSED : HEADER_PADDING_EXPANDED} wrapp-header py-4 border-b border-solid fixed top-0 left-0 right-0 bg-[#fff] z-70 transition-all duration-500 ease-linear`}>
            ...
            <div className="relative w-full">
                {/* Mobile Menu */}
                <div className={`${isMenuOpen ? 'block' : 'hidden'} md:hidden absolute top-0 left-0 z-81 w-full border border-solid bg-white shadow-md`}>
